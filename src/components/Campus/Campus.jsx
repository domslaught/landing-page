...
function Campus() {
  ...
  return (
    <section className="campus-section">
      {/* LEFT: stark framed visual (inverted from About) */}
      <div className="campus-left">
        <div className="campus-frame-accent" />
      </div>

      {/* RIGHT: Sharp Typographic Statement Panel */}
      <div className="campus-right">
        <div className="campus-content">
          <span className="campus-eyebrow">Campus Life</span>
          <h2 className="campus-tagline">Cefizen<br />Life.</h2>
          ...
          <div className="campus-facts">
            ...
            <div className="campus-fact-block">
              <h4>601–<span ref={refRank}>{rank}</span></h4>
